...
import cl.duoc.integracionwebpayamb.model.dto.WebPayStatusResponse;
...
public class WebPayService {
    ...
    public WebPayStatusResponse transactionStatus(WebPayTransactionInitRequest request) {
        return webPayFeignClient.transactionStatus(webPayApiKeyId, webPayApiKeySecret, request);
    }
}
